...
const banner2 = cfonts.render(('Canal: https://youtube.com/c/PLMODS'), {
font: 'console',
align: 'center',
gradrient: [`${cor4}`,`${cor2}`], 
...
const banner3 = cfonts.render((`MANUELA MD 2.0`), {
font: 'tiny',             
align: 'center',           
...
authorname = 'MANUELA-MD-2.0'
packname = '-PL-'
  
function addMetadata(packname, author) {	
if (!packname) packname = '-PL-'; if (!author) author = 'MANUELA-MD-2.0';	
...
chyt = `5521995125645@s.whatsapp.net`
